...
import * as esbuildWasm from "https://unpkg.com/esbuild-wasm@0.14.51/esm/browser.js";
...
export { denoPlugin } from "https://deno.land/x/esbuild_deno_loader@0.5.1/mod.ts";
